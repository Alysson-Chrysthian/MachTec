...
">
    ...
    ">
        ...
        ">
            <flux:heading class="font-bold text-[2rem]" level="2">Plano mensal - R$ 29.99</flux:heading>
            <flux:text>
        ...
        <div class="
            ...
            rounded-md p-4 w-10/12 max-w-[400px]
        ">
            <flux:heading class="font-bold text-[2rem]" level="2">Plano anual - R$ 149.99</flux:heading>
            <flux:text>
